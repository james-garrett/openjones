...
//        g2d.drawImage(_jonesImg, x, y, null);
    ...
    private void initButtons(javax.swing.JPanel mapPanel) {
    ...
    /**I don't believe these are actually being used anywhere, paint 
     * seems to steal the functionality that should be done here
     * 
     */
    private void initBuildingPanels() {
        //Building panels
        javax.swing.GroupLayout buildingPanelLayout = new javax.swing.GroupLayout(buildingPanel);
        buildingPanel.setLayout(buildingPanelLayout);
        buildingPanelLayout.setHorizontalGroup(
